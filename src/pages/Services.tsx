          ...
          {s.pricing.plans.map((plan) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <span className="font-mono text-xs text-(--color-gold)">{plan.n}</span>
              ...
              <div className="mt-6 flex items-baseline gap-2">
                <span className="font-display text-4xl tracking-tight text-(--color-bone)">{plan.price}</span>
              </div>
              ...
              <ul className="mt-8 flex-1 space-y-3.5">
                {plan.features.map((f) => (
                  <li key={f} className="flex items-start gap-2.5 text-sm leading-relaxed text-(--color-fog)">
                    <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full" style={{ background: plan.color }} />
                    {f}
                  </li>
                ))}
              </ul>
